...
srep <- read.table("/projects/cgr/workspaces/analytics-100_UKBWGS_CNV_PheWAS/00_common/00_Resource/10_GenomicRegions/simpleRepeat_hg38.txt", sep = "\t", header = F, as.is = T)
srep <- srep[,2:4]
